...
class ProfilePageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
                ...
                'github_url': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'github_url'}),
                'telegram_url': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'telegram_url'}),
